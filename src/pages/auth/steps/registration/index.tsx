        ...
        <React.Fragment>
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <Input onChange={handleChangeEmail} label={t('auth.login.form.email.label')} id="userEmail" name="email" type="email" placeholder="email@example.com" />
                    ...
                    <Input onChange={handleRepeatPassword} label={t('auth.login.form.repeat.password.label')} id="repeatPassword" name="repeatPassword" type="password" placeholder="••••••" />
                </div>
